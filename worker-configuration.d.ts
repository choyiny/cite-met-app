/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: a123201de6a89d6dfee3aec7e1921b87)
// Runtime types generated with workerd@1.20250902.0 2025-09-06 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUTH_EMAIL_FROM: "hello@cite-met.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_EMAIL_FROM" | "RESEND_API_KEY" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
